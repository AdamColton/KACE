...
<html>
  <head>
    ...
    <script>
      ...
      var trapdoor = new Trapdoor(200, 350);
      ...
      function toggledoor(){
        if (trapdoor.isOpen()){
          trapdoor.close();
          $("trapdoorSwitch").innerHTML = "Open Trapdoor";
        } else {
          trapdoor.open();
          $("trapdoorSwitch").innerHTML = "Close Trapdoor";
        }
      }
    </script>
    <style>
  ...
  <body>
    ...
    <button id="trapdoorSwitch" onclick="toggledoor()">Open Trapdoor</button>
  </body>
</html>