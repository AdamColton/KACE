...
function GridLocation(v){
  var dx = (v.x % Grid.prototype.size[0]);
  var dy = (v.y % Grid.prototype.size[1]);
  if (dx < 0) dx += Grid.prototype.size[0]
  if (dy < 0) dy += Grid.prototype.size[1]
  var x = v.x - dx;
  var y = v.y - dy;
